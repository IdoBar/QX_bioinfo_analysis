...
output: 
    bookdown::html_document2:
      includes:
        ...
        in_footer: style/external-links-js.html
      df_print: paged
      theme: 
        version: 5
...
PromethION data was first demultiplexed with Guppy, then the resulting `fast5` files were converted to `pod5` files using [pod5 package](https://pod5-file-format.readthedocs.io/en/0.2.0/docs/tools.html){target="_blank"}.  
