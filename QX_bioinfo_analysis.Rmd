...
cd \$SLURM_SUBMIT_DIR
# Functional annotation
funannotate annotate -i fun --tmpdir /scratch/project/adna/tmp --cpus \$SLURM_CPUS_PER_TASK --busco_db protists --no-progress --iprscan $(find $WORKDIR/ipscan -name *.proteins.fa.xml)" >  $JOB_NAME.slurm
# submit to the cluster
sbatch $JOB_NAME.slurm
...
This document was last updated at `r Sys.time()` using R Markdown (built with `r R.version.string`). The source code for this website can be found on <https://github.com/IdoBar/QX_bioinfo_analysis>.
