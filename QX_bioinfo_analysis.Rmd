...
```{bash rclone-copy2}
rclone copy -P -L --ignore-checksum --ignore-size --exclude "**work/*" --exclude "**nextflow/*" --exclude "**.nextflow*" $WORKDIR Niki_QX:General/Niki_Nenadic/Niki_PhD/SRO_QX_genomic_data
```
